...
type RepositoryVehicle interface {
	...
	CheckDuplicateVehicle(ctx context.Context, vehicleCategoryID int64, name string) (int64, error)
	GetVehiclesByVehicleCategoryID(ctx context.Context, vehicleCategoryID int64) ([]*Vehicle, error)
}
